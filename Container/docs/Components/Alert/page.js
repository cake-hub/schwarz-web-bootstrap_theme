...
const AlertIconsAside = () => (
    <div className="cake-example-cutted-shadow-fix" id="showbox">
        <AlertIconAside className="alert-primary" iconName="information-circle" iconTitle="Info" alertHeadline="Information!">
...
const AlertDismissing = () => (
    <div className="cake-example-cutted-shadow-fix" id="showbox">
        <Alert className="alert-danger alert-dismissible fade show">
