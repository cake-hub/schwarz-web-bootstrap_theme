...
const PaginationDefault = () => (
    <Pagination>
        <PaginationItem><Icon name="arrow-left" title="Previous" className="btn-icon icon-2" /></PaginationItem>
        <PaginationItem>1</PaginationItem>
        <PaginationItem>2</PaginationItem>
        <PaginationItem>3</PaginationItem>
        <PaginationItem><Icon name="arrow-right" title="Next" className="btn-icon icon-2" /></PaginationItem>
    </Pagination>
);

const PaginationDisabledActiveState = () => (
    <Pagination>
        <PaginationItem className="disabled" disabled tabIndex="-1" aria-disabled="true"><Icon name="arrow-left" title="Previous" className="btn-icon icon-2" /></PaginationItem>
        <PaginationItem>1</PaginationItem>
...
const PaginationWithoutLink = () => (
    <Pagination>
        <PaginationItemNotLinked className="disabled" tabIndex="-1" aria-disabled="true"><Icon name="arrow-left" title="Previous" className="btn-icon icon-2" /></PaginationItemNotLinked>
        <PaginationItem>1</PaginationItem>
...
const PaginationVariants = () => (
    <React.Fragment>
        ...
        <Pagination>
            <PaginationItem className="disabled" tabIndex="-1" aria-disabled="true"><Icon name="arrow-left" title="Previous" className="btn-icon icon-2" /></PaginationItem>
